         ...
         if current_slice + j < len(images):
              ...
              if im_cut.size >= 128:
                if np.mean(im_cut) < 250:
                    ...
                    im_cut.save("C:/Users/kuma/Dropbox/Unvisualizable_augmentation_CT/Cropped_images_radiomics/Malignancy{0}/mal{0}_{1}_{2}.png".format(i, p_id, j))
                    mask_cut.save('C:/Users/kuma/Dropbox/Unvisualizable_augmentation_CT/Cropped_images_radiomics/Malignancy{0}_mask/mal{0}_{1}_{2}_mask.png'.format(i, p_id, j))
